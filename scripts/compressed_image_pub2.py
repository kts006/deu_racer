...
if __name__ == "__main__":
   my_device_id = int(rospy.get_param("/center_camera/device_id", "0"))
   my_width = int(rospy.get_param("/center_camera/image_width", "640"))
   my_height = int(rospy.get_param("/center_camera/image_height", "480"))
   my_bright = float(rospy.get_param("/center_camera/bright","0.5"))
