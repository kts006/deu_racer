...
class Follower:
    ...
    def image_callback(self, msg):
        ...
        lower_yellow_line = np.array([ 25,  35, 245])
        upper_yellow_line = np.array([ 50, 255, 255])
        lower_white_line = np.array([ 0,  0,  245])
        upper_white_line = np.array([255, 20, 255])
