...
class Turtlebot(object):
    ...
    def __parking_moving(self):

          move_distance(0.1)#forward
          #robot.wait(0.6)#not to slip

          turn_angle(radians(78),radians(78))#90
          wait(0.6)

          #이 쯤에서 장애물 체크
          #장애물이 없다면 아래를 실행

          move_distance(0.3)#forward
          wait(2.0)#wait for stay(2s waiting)

          turn_angle(radians(158), radians(158))#180
          wait(0.6)#not to slip

          move_distance(0.3)#forward
          #robot.wait(0.6)

          turn_angle(radians(78), radians(78))
          wait(0.6)
